 ...
 */
final class Version20220724223003 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE author (id INT NOT NULL, name VARCHAR(500) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE book (id INT NOT NULL, title VARCHAR(500) NOT NULL, isbn VARCHAR(13) DEFAULT NULL, page_count SMALLINT NOT NULL, published_date DATE NOT NULL, thumbnail_url VARCHAR(3000) DEFAULT NULL, short_description TEXT DEFAULT NULL, long_description TEXT DEFAULT NULL, status VARCHAR(20) NOT NULL, image TEXT DEFAULT NULL, PRIMARY KEY(id))');
